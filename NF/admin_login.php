...
<div class="container">
    <div class="row align-items-center d-flex flex-column text-center mt-5">
        <div class="col-md-4">
            ...
            <a href="user_login.php" class="btn btn-info btn-sm mt-3">User Login</a>
            <a href="admin_login.php" class="btn btn-warning btn-sm mt-3">Admin Login</a>
        </div>
               ...
               <img src="images/NF.jpg" alt="logo" style="width:15%;height:15%;border-radius:50%;margin:25px;border:2px solid blue;">
                 <h6 class="text-white">ADMIN LOGIN</h6>
                  ...
                  <div class="form-group mb-5 mt-3 text-white">
                      ...
                      <input type="text" name="apassword" id="password">
                  </div>
